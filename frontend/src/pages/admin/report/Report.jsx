                    ...
                    <div className="card">
                        ...
                        <div className="report-stats">
                            ...
                            <div className="stat-card eligible">
                                <div className="stat-value">{stats.eligibleStudents}</div>
                                <div className="stat-label">Đủ điều kiện</div>
                            </div>
                            <div className="stat-card ineligible">
                                <div className="stat-value">{stats.ineligibleStudents}</div>
                                <div className="stat-label">Không đủ điều kiện</div>
                            </div>
                        </div>

                        <div className="chart-container">
                            <h3 className="chart-title">Tỷ lệ sinh viên đủ điều kiện dự thi</h3>
